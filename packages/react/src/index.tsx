...
type EdgeStoreContextValue<TRouter extends AnyEdgeStoreRouter<any>> = {
...
export function createEdgeStoreProvider<
  TRouter extends AnyEdgeStoreRouter<any>
>() {
...
function EdgeStoreProviderInner<TRouter extends AnyEdgeStoreRouter<any>>({
  children,
  context,
  basePath,
}: {
