...
- Stage 4b: reproducible installer implemented. All 335 CLI tests, CLI typecheck/lint/build, generator typecheck/lint, docs contract tests, deterministic asset check and exact canonical-byte real-tarball check passed. Skills and MCP have separate ownership files; both plans preflight before writes. Context now reports per-client visible configurations. Existing React Router/Astro full-stack classification preserved. Draft publication in progress.
