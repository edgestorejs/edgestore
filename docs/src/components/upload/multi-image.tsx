          ...
          return (
            ...
            >
              ...
              {displayUrl && !initialDisabled && (
                <button
                  type="button"
                  className="group pointer-events-auto absolute right-1 top-1 z-10 -translate-y-1/4 translate-x-1/4 transform rounded-full !border !border-solid !border-muted-foreground !bg-background p-1 shadow-md transition-all hover:scale-110"
                  onClick={(e) => {
                    e.stopPropagation();
