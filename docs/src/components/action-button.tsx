...
export function ActionButton({
  ...
  return (
    <Button
      ...
      size={size}
      className={cn(
        'from-primary to-primary/80 dark:text-shadow-[0_2px_4px_rgba(0,0,0,0.5)] group relative inline-flex items-center justify-center overflow-hidden bg-gradient-to-r text-white shadow-lg transition-all duration-300 hover:shadow-[0_0_30px_rgba(170,153,255,0.4)]',
        className,
      )}
      {...props}
    >
