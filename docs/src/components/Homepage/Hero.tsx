...
import { JoinButton, LearnMoreButton } from "."
        ...
        <section>
            <div className="max-w-screen-xl mx-auto px-4 py-28 gap-12 text-gray-600 md:px-8 xl:flex">
                <div className="space-y-5 max-w-2xl mx-auto text-center xl:text-left">
                    <div className="flex flex-wrap items-center justify-center gap-6 xl:justify-start">
                        {
                            features.map((item, idx) => (
                                <div key={idx} className="flex items-center gap-x-2 text-gray-300 text-sm">
                                    {item.icon}
                                    {item.name}
                                </div>
                            ))
                    ...
                    <h1 className="text-4xl text-gray-100 font-[600] mx-auto md:text-5xl">
                        Edge Store
                    </h1>
                    <p className="max-w-[80%] md:max-w-xl mx-auto xl:mx-0 text-base font-[500] lg:text-lg text-gray-300">
                        File Uploads in Next.js Just Got Way Easier! Simplifying Uploads for Seamless Integration in Your Project.
                    </p>
                    <div className="items-center justify-center gap-x-3 space-y-3 flex flex-col sm:flex-row sm:space-y-0 xl:justify-start">
                        <JoinButton />
                        <LearnMoreButton />
                    </div>
                </div>
                <div className="flex-1 max-w-xl mx-auto mt-14 xl:mt-0">
                    <div className="relative">
                        <div className="relative overflow-hidden max-w-[80vw] mx-auto">
                            <YouTubeEmbed videoId="Acq9UEA2akU" />
                        </div>
            ...
            {
                isVideoPoppedUp ? (
                    <div className="fixed backdrop-blur-md z-[9999] inset-0 w-full h-full flex items-center justify-center">
                        ...
                        <div className="px-4 relative w-full h-full">
                            ...
                            <YouTubeEmbed videoId="Acq9UEA2akU" width="100%" height="80%" />
                        </div>
                    </div>
                ) : ""
            }
