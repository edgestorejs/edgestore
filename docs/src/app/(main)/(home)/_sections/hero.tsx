  ...
  return (
    <UploaderProvider uploadFn={uploadFn} autoUpload>
      <div className="container flex flex-col items-center gap-8 py-20 lg:flex-row lg:py-40">
        <div className="flex w-full min-w-0 flex-2 flex-col items-center gap-6 lg:items-start">
          <h1 className="text-center text-3xl font-bold text-foreground min-[380px]:text-4xl min-[420px]:text-5xl md:text-6xl lg:text-left lg:text-5xl">
            The best way to
          ...
          <p className="text-md max-w-[600px] text-center text-balance text-muted-foreground lg:text-left lg:text-lg">
