...
```bash
pnpm dlx shadcn@latest add https://edgestore.dev/r/single-image
```
...
```bash
npx shadcn@latest add https://edgestore.dev/r/single-image
```
...
```shell
bunx --bun shadcn@latest add https://edgestore.dev/r/single-image
```
