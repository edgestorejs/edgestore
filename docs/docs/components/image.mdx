...
```bash
pnpm dlx shadcn@latest add https://edgestore-docs-git-new-components-edgestore.vercel.app/r/single-image-dropzone.json
```
...
```bash
npx shadcn@latest add https://edgestore-docs-git-new-components-edgestore.vercel.app/r/single-image-dropzone.json
```
...
```shell
bunx --bun shadcn@latest add https://edgestore-docs-git-new-components-edgestore.vercel.app/r/single-image-dropzone.json
```
