...
```bash
pnpm dlx shadcn@latest add https://edgestore-docs-git-new-components-edgestore.vercel.app/r/progress-circle.json
```
...
```bash
npx shadcn@latest add https://edgestore-docs-git-new-components-edgestore.vercel.app/r/progress-circle.json
```
...
```shell
bunx --bun shadcn@latest add https://edgestore-docs-git-new-components-edgestore.vercel.app/r/progress-circle.json
```
