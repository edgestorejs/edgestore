...
```bash
pnpm dlx shadcn@latest add https://edgestore.dev/r/dropzone
```
...
```bash
npx shadcn@latest add https://edgestore.dev/r/dropzone
```
...
```shell
bunx --bun shadcn@latest add https://edgestore.dev/r/dropzone
```
