...
<DemoBlock
  v0Config={{
    ...
    registryUrl:
      'https://edgestore-docs-git-new-components-edgestore.vercel.app/r/progress-bar-block.json',
  }}
>
  <ProgressBarUsage />
</DemoBlock>
...
```bash
pnpm dlx shadcn@latest add https://edgestore-docs-git-new-components-edgestore.vercel.app/r/progress-bar.json
```
...
```bash
npx shadcn@latest add https://edgestore-docs-git-new-components-edgestore.vercel.app/r/progress-bar.json
```
...
```shell
bunx --bun shadcn@latest add https://edgestore-docs-git-new-components-edgestore.vercel.app/r/progress-bar.json
```
