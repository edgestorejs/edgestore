...
```bash
pnpm dlx shadcn@latest add https://edgestore.dev/r/uploader-provider
```
...
```bash
npx shadcn@latest add https://edgestore.dev/r/uploader-provider
```
...
```shell
bunx --bun shadcn@latest add https://edgestore.dev/r/uploader-provider
```
