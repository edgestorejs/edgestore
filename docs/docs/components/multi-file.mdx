...
<DemoBlock
  ...
  v0Config={{
    ...
    registryUrl:
      'https://edgestore-docs-git-new-components-edgestore.vercel.app/r/file-uploader-block.json',
  }}
>
...
```bash
pnpm dlx shadcn@latest add https://edgestore-docs-git-new-components-edgestore.vercel.app/r/file-uploader.json
```
...
```bash
npx shadcn@latest add https://edgestore-docs-git-new-components-edgestore.vercel.app/r/file-uploader.json
```
...
```shell
bunx --bun shadcn@latest add https://edgestore-docs-git-new-components-edgestore.vercel.app/r/file-uploader.json
```
