...
EdgeStore v1 packages are ESM-only and support Node.js 22.22.0 or later, including
Node.js 24. Upgrade older Node.js runtimes before installing v1. Building the
EdgeStore repository itself requires Node.js 24 or later.
