...
- For unreleased work, update the existing changeset to describe the final
  feature rather than adding entries for intermediate fixes or wording changes.
  Do not bump a plugin's version before its first release.
